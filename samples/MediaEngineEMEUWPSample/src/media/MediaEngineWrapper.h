...
class MediaEngineWrapper : public winrt::implements<MediaEngineWrapper, IUnknown>
{
  public:
    ...
    // Create the media engine with the provided media source and CDM
  ...
  private:
    ...
    void CreateMediaEngine(IMFMediaSource* mediaSource, std::shared_ptr<eme::MediaKeys> mediaKeys);
    void OnLoaded();
